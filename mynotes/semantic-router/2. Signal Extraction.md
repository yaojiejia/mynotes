...
Layer 1 of [[1. Overview]] · [[3. Decision Engine]] · [[4. Plugin Chain]]
...
Same request used across [[1. Overview]], [[3. Decision Engine]] and [[4. Plugin Chain]]:
...
Note the mix. Two of those 1.0 values are placeholders standing in for "matched, no opinion on how strongly," and one is a genuine score. That distinction is invisible here but decides how ranking behaves one layer up, which is the `ConfidenceScored` story in [[3. Decision Engine]].
